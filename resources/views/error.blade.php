...
<head>
    ...
    <title>Barber Vintage -Error</title>
    <!-- Custom CSS -->
...
<div class="main-wrapper">
    ...
    <div class="error-box">
        <div class="error-body text-center">
            ...
            <h3 class="text-uppercase error-subtitle">VOUS AVEZ COMMIS UNE ERREUR!</h3>
            <p class="text-muted m-t-30 m-b-30">VOUS AVEZ L'AIR PERDU</p>
            <a href="{{route('home')}}" class="btn btn-danger btn-rounded waves-effect waves-light m-b-40">Cliquez ici pour retourner au menu principal</a> </div>
    </div>
    <!-- ============================================================== -->
    <!-- Login box.scss -->
    <!-- ============================================================== -->
