    ...
    <div class="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                @if($vide)
                    <div class="col-12">
                        <h1 class="titles">  لا يوجد أيام توقف عن العمل</h1> <br>
                        <img src="{{ URL::to('/bg-img/happy.png') }}" class="sad" />
                                                        ...
                                                        <form method="post" action="{{route('editweekday')}}" onsubmit="confirm('Confirmer modification svp?')" >     <div class="modal-body">
                                                            ...
                                                            <table class="table-responsive">
                                                                ...
                                                                <tbody>
                                                                 ...
                                                                 <tr>
                                                                    <td>
                                                                        {{$day->date}}<input type="hidden" name="date" value="{{$day->date}}">
                                                                    </td>
                                                                    <td>
                                                                        <input type="time" name="H_debut" value="{{$day->H_debut}}">
                                                                    </td>
                                                                    <td>
                                                                        <input type="time" name="H_fin" value="{{$day->H_fin}}">
                                                                     </td></tr>
