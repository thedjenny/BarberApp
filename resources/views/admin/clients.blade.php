                                ...
                                <div class="table-responsive">
                                    <table id="zero_config" class="table table-striped table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$c->date}}</td>
                                            <td> <!-- new Content -->
                                                <button type="button" class="btn btn-cyan" data-toggle="modal" data-target="#exampleModal{{$loop->iteration}}" @if($c->blocked) disabled @endif>
                                                    {{ __('Modifier') }}
                                                </button>
                                                @if($c->blocked)
                                                    <form method="post" action="{{route('debloquerClient')}}">
                                                ...
                                                <div class="modal fade" id="exampleModal{{$loop->iteration}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <form method="post" action="{{route('editPoints')}}" onsubmit="confirm('Vous remettez les points à \''+ document.getElementById('points{{$loop->iteration}}').value + '\' svp?')" >     <div class="modal-body">
                                                                    ...
                                                                    <table class="table-responsive" >
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                {{$c->username}}<input type="hidden" name="username" value="{{$c->idClient}}">
                                                                            </td>
                                                                         <td>

                                                                                <input type="number" name="points" id="points{{$loop->iteration}}" value="{{$c->points}}">
                                                                            </td>
                                                                            <td>
                                                                                <button type="submit" class="btn btn-success" >Enregistrer points</button>
                                                                            </td>
                                                                           </tr>
