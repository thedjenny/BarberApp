        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="post" action="{{route('saveOpSettings')}}">


                        <div class="form-group row">
                            <label class="col-md-3">Temps Debut-Fin de travail</label>
                            <div class="col-md-9">
                                <div class="custom-control custom-checkbox mr-sm-2">
                                    <input id="appt-time" type="time" name="beg" @if ($settings == null) value="10:00" @else value="{{$settings->H_debut}}" @endif required>
                                    <input id="appt-time" type="time" name="end" @if ($settings == null) value="20:00" @else value="{{$settings->H_fin}}" @endif required>
                                </div>

                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3">Temps Pause-Retour au travail</label>
                            <div class="col-md-9">
                                <div class="custom-control custom-checkbox mr-sm-2">
                                    <input id="appt-time" type="time" name="pause" step="300"  @if ($settings == null) value="13:00" @else value="{{$settings->H_pause}}" @endif  required>
                                    <input id="appt-time" type="time" name="back" @if ($settings == null) value="14:00" @else value="{{$settings->H_retour}}" @endif required >
                                </div>

                            </div>
                        </div>
                        <b>NB: Veuillez choisir des heures piles "Ex: 09:00" </b>
