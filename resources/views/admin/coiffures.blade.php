        ...
        function onClickDelete(nom , id) {
                ...
                if (result) {
                    $.ajax({
                        ...
                        url: '/admin/deleteCoiffure',


                        success: function()
                        {
                            window.location.href = "{{ route('getCoiffures')}}";
        ...
        <div class="page-breadcrumb">
            <div class="row">
                <div class="col-12 d-flex no-block align-items-center">
                    <button class="btn btn-success" data-toggle="modal" data-target="#AjoutModal">Ajouter nouvelle coiffure</button>
                </div>
            </div>
        </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Ajouter Coiffure</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Annuler">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <form method="post" action="{{route('addCoiffure')}}" enctype="multipart/form-data">
                        <div class="card">
                            <div class="card-body">

                                <div class="form-group row">
                                    <label class="col-md-3" for="disabledTextInput">Nom coiffure</label>
                                    <div class="col-md-9">
                                        <input type="text" id="disabledTextInput" class="form-control" name="nom" placeholder="Degradé" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3" for="prix">Prix</label>
                                    <div class="col-md-9">
                                        <input type="number" id="prix" name="prix" class="form-control" placeholder="500.00DA" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3" for="temps">points de coiffure</label>
                                    <div class="col-md-9">
                                        <input type="number" id="temps" class="form-control" name="points" placeholder="50" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3" for="temps">Temps coiffure (H:M)</label>
                                    <div class="col-md-4">
                                        <select name="hours" class="select2 form-control custom-select select2-hidden-accessible" aria-label="Default select example" required>
                                            <option selected value="0">0 H</option>
                                    ...
                                    <div class="col-md-4">
                                        <select name="minutes" class="select2 form-control custom-select select2-hidden-accessible" aria-label="Default select example" required>
                                ...
                                <div class="form-group row">
                                    <div class="col-md-9">
                                        <label class="col-md-3">Photo coiffure</label>
                                ...
                                <table id="zero_config" class="table table-striped table-bordered">
                                    ...
                                    @foreach($coiffures as $c)
                                        <tr>
                                            ...
                                            <td>{{$c->points}}</td>
                                            <td> <!-- new Content -->
                                                <button type="button" class="btn btn-danger" id="deleteC" onclick="onClickDelete('{{$c->nom}}' , '{{$c->id}}')">
