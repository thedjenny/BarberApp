...
<head>
    ...
    <title>Taki Barbershop -Administrateur</title>
    <!-- Custom CSS -->
    <link rel="stylesheet" type="text/css" href="{{asset('/template/admin/assets/libs/select2/dist/css/select2.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('/template/admin/assets/libs/jquery-minicolors/jquery.minicolors.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('/template/admin/assets/libs/quill/dist/quill.snow.css')}}">
...
<div class="page-wrapper">
    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
                <h4 class="page-title">Barbershop: Weekends</h4>
    ...
    <div class="container-fluid">
        ...
        <!-- ============================================================== -->
            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Parametres du magasin</h4><hr>


                    <form method="post" action="{{route('saveSettings')}}">
                    <div class="form-group row">
                        <label class="col-md-3">Weekends</label>
                        <div class="col-md-9">
                            <div class="custom-control custom-checkbox mr-sm-2">
                                <input type="checkbox" name="checkedDay0" value="Samedi" class="custom-control-input" id="customControlAutosizing1" @if (in_array("Samedi", $weekends)) checked="checked" @endif >
                                <label class="custom-control-label" for="customControlAutosizing1">Samedi</label>
                            </div>
                            <div class="custom-control custom-checkbox mr-sm-2">
                                <input type="checkbox" name="checkedDay1" value="Dimanche" class="custom-control-input" id="customControlAutosizing2" @if (in_array("Dimanche", $weekends)) checked="checked" @endif>
                                <label class="custom-control-label" for="customControlAutosizing2">Dimanche</label>
                            </div>
                            <div class="custom-control custom-checkbox mr-sm-2">
                                <input type="checkbox" name="checkedDay2" value="Lundi" class="custom-control-input" id="customControlAutosizing3" @if (in_array("Lundi", $weekends)) checked="checked" @endif >
                                <label class="custom-control-label" for="customControlAutosizing3">Lundi</label>
                            </div>
                            <div class="custom-control custom-checkbox mr-sm-2">
                                <input type="checkbox" name="checkedDay3" value="Mardi" class="custom-control-input" id="customControlAutosizing4" @if (in_array("Mardi", $weekends)) checked="checked" @endif >
                                <label class="custom-control-label" for="customControlAutosizing4">Mardi</label>
                            </div>
                            <div class="custom-control custom-checkbox mr-sm-2">
                                <input type="checkbox" name="checkedDay4" value="Mercredi" class="custom-control-input" id="customControlAutosizing5" @if (in_array("Mercredi", $weekends)) checked="checked" @endif>
                                <label class="custom-control-label" for="customControlAutosizing5">Mercredi</label>
                            </div>
                            <div class="custom-control custom-checkbox mr-sm-2">
                                <input type="checkbox" name="checkedDay5" value="Jeudi" class="custom-control-input" id="customControlAutosizing6" @if (in_array("Jeudi", $weekends)) checked="checked" @endif>
                                <label class="custom-control-label" for="customControlAutosizing6">Jeudi</label>
                            </div>
                            <div class="custom-control custom-checkbox mr-sm-2">
                                <input type="checkbox" name="checkedDay6" value="Vendredi" class="custom-control-input" id="customControlAutosizing7"  @if (in_array("Vendredi", $weekends)) checked="checked" @endif >
                                <label class="custom-control-label" for="customControlAutosizing7">Vendredi</label>
                            </div>
                        </div>
                    </div><hr>

                    <div class="form-group row">
                        <label class="col-md-3">Temps Debut-Fin de Weekend</label>
                        <div class="col-md-9">
                            <div class="custom-control custom-checkbox mr-sm-2">
                                <input id="appt-time" type="time" name="beg" value="10:00">
                                <input id="appt-time" type="time" name="end" value="20:00">
                            </div>
...
<!-- this page js -->
    <script src="{{asset('template/admin/assets//libs/inputmask/dist/min/jquery.inputmask.bundle.min.js')}}"></script>
    <script src="{{asset('template/admin/dist/js/pages/mask/mask.init.js')}}"></script>
    <script src="{{asset('template/admin/assets/libs/select2/dist/js/select2.full.min.js')}}"></script>
    <script src="{{asset('template/admin/assets/libs/select2/dist/js/select2.min.js')}}"></script>
    <script src="{{asset('template/admin/assets/libs/jquery-asColor/dist/jquery-asColor.min.js')}}"></script>
    <script src="{{asset('template/admin/assets/libs/jquery-asGradient/dist/jquery-asGradient.js')}}"></script>
    <script src="{{asset('template/admin/assets/libs/jquery-asColorPicker/dist/jquery-asColorPicker.min.js')}}"></script>
    <script src="{{asset('template/admin/assets/libs/jquery-minicolors/jquery.minicolors.min.js')}}"></script>
    <script src="{{asset('template/admin/assets/libs/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js')}}"></script>
    <script src="{{asset('template/admin/assets/libs/quill/dist/quill.min.js')}}"></script>
    <script>
        //***********************************//
        // For select 2
        //***********************************//
